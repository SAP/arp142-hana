#!/usr/bin/env bash
#------------------------------------------------------------------
# bashunit migration: 7021_ha_resource_agent_angi_sles_test.sh
# Tests for HA resource agent SAPHanaSR-angi check on SLES
#------------------------------------------------------------------
set -u
...
function test_rpm_not_installed() {
    ...
    #act
    check_7021_ha_resource_agent_angi_sles
    local rc=$?
...
function set_up_before_script() {
    ...
    #shellcheck source=../../lib/check/7021_ha_resource_agent_angi_sles.check
    source "${PROGRAM_DIR}/../../lib/check/7021_ha_resource_agent_angi_sles.check"
}
