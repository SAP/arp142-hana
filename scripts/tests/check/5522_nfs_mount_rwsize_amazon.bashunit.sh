#!/usr/bin/env bash
#------------------------------------------------------------------
# bashunit migration: 5522_nfs_mount_rwsize_amazon_test.sh
# Tests for NFS mount rsize/wsize check on Amazon
#------------------------------------------------------------------
set -u
...
function test_nfs_not_mounted() {
    ...
    #act
    check_5522_nfs_mount_rwsize_amazon
    local rc=$?
...
function set_up_before_script() {
    ...
    #shellcheck source=../../lib/check/5522_nfs_mount_rwsize_amazon.check
    source "${PROGRAM_DIR}/../../lib/check/5522_nfs_mount_rwsize_amazon.check"
}
