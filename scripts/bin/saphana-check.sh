...
function main {
    ...
    printf -v _line_formated "%5.0f GiB (%d MiB)" $(((LIB_PLATF_PMEM_KiB + 1048575) / 1048576)) "$((LIB_PLATF_PMEM_KiB / 1024))"
    logNotify "## PMEM attached:  ${_line_formated}"
    printf -v _line_formated "1 : %.0f" "$(( 10**1 * (LIB_PLATF_PMEM_KiB/1024)/LIB_PLATF_RAM_MiB_AVAILABLE ))e-1"
